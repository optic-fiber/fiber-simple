...
//    void i_set_path_to_current_directory() throws Throwable {
//        basePath = new File(applicationContext
//                .getResource(separator).URI).path
//    }
//
...
//    }
//
//    @Then("I build the workbook in the file {string}")
//    void his_last_name_is(String filename) throws Throwable {
//        File result = classeurResource.file
